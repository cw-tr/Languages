...
1990 ve 2000'li yıllarda mühendislik bölümleri okuyan (Makine, Elektrik-Elektronik vb) tüm bilim insanları Sinyal modellemeleri, dev matris tersleme işlemleri yapmak zorundaydı. Bütün donanım dünyasının formülü "MATLAB" diliyle yazılırdı. Ancak MATLAB, şirketler ve zengin ABD okulları için binlerce dolara satılıyordu. Fakir bir öğrenci, ya da Pakistan/Hindistan/Türkiye'deki bir doktora öğrencisi evinde bu mühendislik ödevini yapamıyordu.
...
Makine öğreniminin o Matrix/Ağırlık güncellemelerini For döngüsü kullanmadan sadece Matematik (Cebir) Sembolizmi ile milisaniyede GPU/CPU vuran o efsane yapı:
...
```
Siz "Run" dediğiniz an, sistemin içinde "Figure 1" diye minik bağımsız harika bir Görüntü Ekranı çıkar ve Linear Cebirin mühendislik hesaplarıyla kucaklanmış 2D renkli grafik raporunuz anında belirir! Kanser hücre tespitinden radar sinyali işlemeye kadar her yeri bu kod döker.
