...
- **Komutların Şifresi:** Diyelim ki Kırmızı kutudan Çıktı, Koyu Yeşil kutuya girdi! Derleyici bunu görür, Renk çarkında "Kaç adım dönmüş, Ne kadar Koyulaşmış" diye Çark Matematigi yapar. Bu değişim mesafesi ÖRN: "Topla (Add)" demektir! Veya "Ekrana Bas (Print/Out)" demektir.
