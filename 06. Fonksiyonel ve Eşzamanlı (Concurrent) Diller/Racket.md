...
(define-syntax-rule (while sarti_kontrol_et kod_govdesi ...) 
  ;; Bu while gördugun an onu "rekürsif (kendi kendini cagiran) loop-dongusune" cevir!
  (let loop ()
...
* Video oyunlarına veya Web sayfalarına "Statik/Typed" fonksiyonellik katmak isteyip, Makrolar olmadan yaşayamayan hardcore "Eski Toprak" Lisp-sevici bilgisayar hackerları. Kurumsal şirketler Racket'i doğrudan üretimde kullanmazlar lakin kendi iç dil (DSL) sistemlerini yazarken altyapısını soyutlarlar.
