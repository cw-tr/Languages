...
* **Çok Platformluluk:** Başta sadece Windows'ta çalışıyordu ancak bugün ".NET Core/5/6/7/8" sayesinde Microsoft bu dili Linux ve Mac'te de çalışır, açık kaynaklı (Open Source) hale getirdi.
...
Java'daki gibi Getter/Setter adı altında 50 satırlık hantal (boilerplate) özel özellik kodları yazmazdınız. C#'ta değişkenlerin (Properties) `get; set;` adında mikroskobik otomatik özellikleri vardır, tek satırda aynı güvenlik zırhını kurarsınız.
