...
Yıllarca iPhone uygulamaları `[ ]` (köşeli parantezler) ile dolu, mesajlaşma sistematiğine (Smalltalk) dayanan, 1980'lerden kalma çok zor öğrenilen Objective-C dili ile yazıldı. Yazılımcılar Android tarafında tertemiz Java veya C# ile harikalar yaratırken, iOS tarafı C tabanlı bir eziyetle yoğruluyordu.
...
## Kimler Kullanır?
* Tüm Apple "Mobile / iOS" Developer ordusu. Şirketlerin telefonlarımıza indirdiği devasa oyun ve arayüz programlamalarının yapımcıları.
